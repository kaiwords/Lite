        ...
        children: [
          ...
          ClipRRect(
            ...
            child: Container(
              ...
              child: Center(
                child: Icon(listing.type.icon, size: 36, color: Colors.white.withValues(alpha: 0.9)),
              ),
            ),
          ),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Rating
                  _RatingRow(rating: listing.rating, reviewCount: listing.reviewCount, isDark: isDark),
...
class _RatingRow extends StatelessWidget {
  ...
  final bool isDark;
  const _RatingRow({required this.rating, required this.reviewCount, required this.isDark});
    ...
    return Row(
      children: [
        ...
        Text(
          ...
          style: GoogleFonts.lato(fontSize: 12, fontWeight: FontWeight.w600, color: mutedColor),
        ),
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          border: Border.all(
            color: isDark ? AppColors.darkTextSecondary.withValues(alpha: 0.4) : AppColors.textMuted.withValues(alpha: 0.4),
          ),
          borderRadius: BorderRadius.circular(20),
        ),
        child: Row(
...
class _CrossLinkButton extends StatelessWidget {
  ...
  final VoidCallback onTap;
  final bool isDark;
  const _CrossLinkButton({required this.label, required this.icon, required this.onTap, required this.isDark});

  @override
  Widget build(BuildContext context) => CrossLinkButton(
        label: label,
        icon: icon,
        onTap: onTap,
        isDark: isDark,
